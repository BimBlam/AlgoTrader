...
_JOB_ENTRY_POINTS: dict[str, str] = {
    "INGEST_EOD": "s2_data_ingestion.main",
    "RUN_SENTIMENT": "s5_sentiment.main",
    "RUN_SIGNALS": "s3_signal_engine.main",
    "RUN_BACKTEST": "s4_backtest.main",
    "EXECUTE_ORDERS": "s6_execution.main",
    "RECONCILE": "s6_execution.reconcile",
}
