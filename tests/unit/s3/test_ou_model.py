...
from s3_signal_engine.ou_model import (
    OUResult,
    _ols_residuals,
    _fit_single,
    fit_ou_params,
...
class TestFitOUParams:
    def test_skips_tickers_with_missing_ohlcv(self, tmp_path, sample_returns_df):
        ...
        with patch("s3_signal_engine.ou_model._get_cfg") as mock_cfg:
    ...
    def test_bad_ticker_does_not_abort(self, tmp_path, sample_returns_df):
        ...
        with patch("s3_signal_engine.ou_model._get_cfg") as mock_cfg:
            ...
            with patch("s3_signal_engine.ou_model._fit_single", side_effect=RuntimeError("boom")):
                results = fit_ou_params(
                    returns_df=sample_returns_df,
                    etf_returns={},
                    strategy_cfg=strategy_cfg,
