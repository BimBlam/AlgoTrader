"""Tests for algotrader.orchestrator.scheduler."""
...
class TestSchedulerRegistration:
    def test_all_jobs_registered(self):
        callback = MagicMock()
        with patch("algotrader.orchestrator.scheduler.BackgroundScheduler") as mock_sched_cls:
...
class TestDispatchCallback:
    def test_dispatch_fn_calls_callback_with_job_types(self):
        ...
        with patch("algotrader.orchestrator.scheduler.BackgroundScheduler"):
            scheduler = JobScheduler(dispatch_callback=callback)
