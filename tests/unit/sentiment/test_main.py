"""
Unit tests for algotrader.sentiment.main.
...
class TestRun:
    ...
    @patch("algotrader.sentiment.main.utc_today", return_value=datetime.date(2025, 1, 15))
    def test_run_writes_event_for_every_ticker(self, mock_today, mock_cfg, tmp_path):
        ...
        with (
            patch("algotrader.sentiment.main.get_config", return_value=mock_cfg),
            patch("algotrader.sentiment.main.init_db"),
            patch("algotrader.sentiment.main.get_session", return_value=mock_session),
            patch("algotrader.sentiment.scorer._load_finbert", return_value=None),
        ):
