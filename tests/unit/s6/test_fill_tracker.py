...
from s6_execution.fill_tracker import FILL_TIMEOUT_SECONDS, FillTracker
...
class TestFillTrackerOnFill:
    @patch("s6_execution.fill_tracker.write_position")
    @patch("s6_execution.fill_tracker.update_order_filled")
    @patch("s6_execution.fill_tracker.write_event")
