"""Unit tests for s5_sentiment.scorer."""

from unittest.mock import patch, MagicMock
import pytest

from s5_sentiment.scorer import (
    ScoredItem,
    MODEL_NONE,
    MODEL_FINBERT,
...
class TestScoreBatchFinbert:
    def test_returns_none_items_when_pipeline_unavailable(self):
        ...
        with patch("s5_sentiment.scorer._load_finbert", return_value=None):
    ...
    def test_successful_batch(self):
        ...
        with patch("s5_sentiment.scorer._load_finbert", return_value=mock_pipe):
